...
public class WxPayController {
    ...
    public String getWXOAuth2Code(HttpServletRequest request, HttpServletResponse response){
        ...
        // scope=snsapi_base 不弹出授权页面，直接跳转返回app_id
        // %s 一个占位符
    ...
    //统一下单，接收openid
    @GetMapping("/wxjspay")
    public ModelAndView wxjspay(HttpServletRequest request) throws Exception {
        //创建sdk客户端
        ...
        jsapiPayParam.put("signType","HMAC-SHA256");//签名算法类型
        //签名，必须放在最后，对前面的数据进行签名
